...
_TOOL_DISPLAY_BY_NAME: dict[str, tuple[str, str]] = {
    ...
    "create_feature_generation": ("ui.startingFeatureGeneration", "Starting quick-tool generation..."),
    "get_feature_generation": ("ui.checkingFeatureGeneration", "Checking quick-tool result..."),
